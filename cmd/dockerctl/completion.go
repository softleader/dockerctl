...
const (
	completionDesc = `Generate autocompletions script for dockerctl for the specified shell (bash or zsh)

	$ slctl completion bash  # for bash users
	$ slctl completion zsh   # for zsh users

Place the following command in your '.bash_profile' or other startup script , e.g.
